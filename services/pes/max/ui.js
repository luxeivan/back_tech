...
function buildMainMenuText(update) {
  ...
  return [
    `Привет, ${name}.`,
    "Это бот модуля ПЭС АО «Мособлэнерго».",
    "",
    "Здесь Вы можете подписаться на уведомления по всем филиалам, отдельному филиалу или конкретному ПО.",
    "",
    "Что будет приходить:",
    "• готовность ПЭС к выезду;",
    "• команда на выезд с адресом, контактами и комментарием;",
    "• корректировка маршрута;",
    "• отмена выезда;",
    "• перевод ПЭС в ремонт или возврат в резерв.",
    "",
    "Под уведомлениями могут быть кнопки действий, например «Фактический выезд», «Подключена», «Вернуть в резерв». Нажимайте их только после фактического выполнения действия.",
    "",
    "Для настройки подписок используйте кнопки ниже.",
  ].join("\n");
}
